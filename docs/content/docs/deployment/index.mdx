...
| `minimal`        | tiny + all providers (Anthropic, Azure, Bedrock, Vertex, Gemini), SQLite, embedded UI, embedded catalog, wizard                                                                                                   | Development, Windows, embedded            |
...
|                         | `provider-vertex`           | Google Vertex AI + Gemini (pulls in `gcp-sdk`)          | minimal     |
